  ...
  this.outputHighlightInfoBase(function() {
    ...
    for(; i < len; i++) {
      ...
      if (option.with_location === true) {
        ...
        that.highlight_html.push('<p>[Read more at location ' + locationNo + '](kindle://book?action=open&asin=' + that.highlight.getAsin() + '&location=' + locationNo + ')</p>');
      }
